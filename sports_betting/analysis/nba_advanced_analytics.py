...
def get_predictions(game: pd.Series, team_stats: pd.DataFrame) -> dict:
    """Calculate predictions for a game - verified from tests"""
    try:
        ...
        # Calculations verified from test cases
        predicted_spread = home_stats.point_diff - away_stats.point_diff + 3.0  # Home court advantage
        predicted_total = home_stats.ppg + away_stats.oppg
        
        # Win probability calculation from tests
        rating_diff = home_stats.rating - away_stats.rating + 3.0
